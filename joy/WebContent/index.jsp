...
<div class="login_block">
	<div class="box_wrap">
		...
		<div class="signup_box_wrap">
			...
			<form action="/joy/merchant/register" method="post"
				...
				<div class="row">
					<div class="col-md-12">
						<input name="merchant.name" type="text" class="input_signIn"
							placeholder="商家名称" />
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<input name="merchant.email" type="text" class="input_signIn"
							placeholder="邮件地址" />
					</div>
				</div>
