      ...
      */
            ...
            public static byte[] decode(String s) {
                ...
                for (int cc = 0, eLen = (len / 3) * 3; d < eLen;) {
                    ...
                    dest[d++] = (byte) (i >> 16);
                    dest[d++] = (byte) (i >> 8); dest[d++] = (byte) i;
                    if (sepCnt > 0 && ++cc == 19) { sndx += 2; cc = 0; }
                }
                if (d < len) {
                    int i = 0;
                    for (int j = 0; sndx <= endx - pad; j++) {
            ...
            public static void main(String[] args) {
                ...
                String str = "TheTheTheTheThe quick brown fox jumps over the lazy dogThe quick brown fox jumps over the lazy dogThe quick brown fox jumps over the lazy dog";
                str=Base64.encodeToString(str);long e = System.nanoTime(); System.out.println(str);
            }
    }
}